...
{
  "$end", "error", "$undefined", "INT_VAL", "FLOAT_VAL", "ID_VAL",
  "INT_TOK", "BOOL_TOK", "BVEC2_TOK", "BVEC3_TOK", "BVEC4_TOK",
  "IVEC2_TOK", "IVEC3_TOK", "IVEC4_TOK", "VEC2_TOK", "VEC3_TOK",
  "VEC4_TOK", "FLOAT_TOK", "MUL_TOK", "ADD_TOK", "SUB_TOK", "DIV_TOK",
  "ASSIGN_TOK", "NOT_TOK", "AND_TOK", "OR_TOK", "XOR_TOK", "LS_TOK",
  "GT_TOK", "LPAREN_TOK", "RPAREN_TOK", "LBRACE_TOK", "RBRACE_TOK",
  "LBRACKET_TOK", "RBRACKET_TOK", "SEMICOL_TOK", "COMMA_TOK", "TRUE_TOK",
  "FALSE_TOK", "IF_TOK", "ELSE_TOK", "WHILE_TOK", "$accept", "program",
